...
use std::any::{Any,TypeId};
	...
	pub const _LITERAL_NAMES: [Option<&'static str>;29] = [
		None, Some("'=='"), Some("'!='"), Some("'in'"), Some("'<'"), Some("'<='"), 
	...
	pub const _SYMBOLIC_NAMES: [Option<&'static str>;38]  = [
		None, Some("EQUALS"), Some("NOT_EQUALS"), Some("IN"), Some("LESS"), Some("LESS_EQUALS"), 
		Some("GREATER_EQUALS"), Some("GREATER"), Some("LOGICAL_AND"), Some("LOGICAL_OR"), 
		Some("LBRACKET"), Some("RPRACKET"), Some("LBRACE"), Some("RBRACE"), Some("LPAREN"), 
		Some("RPAREN"), Some("DOT"), Some("COMMA"), Some("MINUS"), Some("EXCLAM"), 
		Some("QUESTIONMARK"), Some("COLON"), Some("PLUS"), Some("STAR"), Some("SLASH"), 
		Some("PERCENT"), Some("CEL_TRUE"), Some("CEL_FALSE"), Some("NUL"), Some("WHITESPACE"), 
		Some("COMMENT"), Some("NUM_FLOAT"), Some("NUM_INT"), Some("NUM_UINT"), 
		Some("STRING"), Some("BYTES"), Some("IDENTIFIER"), Some("ESC_IDENTIFIER")
	];
	lazy_static!{
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for CELParserExt{
	...
	fn sempred(_localctx: Option<&(dyn CELParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					4 => CELParser::<'input,I,_>::relation_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					5 => CELParser::<'input,I,_>::calc_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					7 => CELParser::<'input,I,_>::member_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
    ...
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
	...
	fn calc_sempred(_localctx: Option<&CalcContext<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				1=>{
	...
	fn member_sempred(_localctx: Option<&MemberContext<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				3=>{
...
pub trait StartContextAttrs<'input>: CELParserContext<'input> + BorrowMut<StartContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
pub trait ExprContextAttrs<'input>: CELParserContext<'input> + BorrowMut<ExprContextExt<'input>>{

fn conditionalOr_all(&self) ->  Vec<Rc<ConditionalOrContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn conditionalOr(&self, i: usize) -> Option<Rc<ConditionalOrContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token COLON
/// Returns `None` if there is no child corresponding to token COLON
fn COLON(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn QUESTIONMARK(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	...
	-> Result<Rc<ExprContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			if _la==QUESTIONMARK {
				...
				let tmp = recog.base.match_token(QUESTIONMARK,&mut recog.err_handler)?;
...
pub type ConditionalOrContext<'input> = BaseParserRuleContext<'input,ConditionalOrContextExt<'input>>;
...
impl<'input> ConditionalOrContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConditionalOrContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ConditionalOrContextExt{
				s9: None, 
				ops: Vec::new(), 
				e: None, conditionalAnd: None, 
				e1: Vec::new(), 
				ph:PhantomData
			}),
		)
...
pub trait ConditionalOrContextAttrs<'input>: CELParserContext<'input> + BorrowMut<ConditionalOrContextExt<'input>>{

fn conditionalAnd_all(&self) ->  Vec<Rc<ConditionalAndContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn conditionalAnd(&self, i: usize) -> Option<Rc<ConditionalAndContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token LOGICAL_OR in current rule
fn LOGICAL_OR_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LOGICAL_OR(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn conditionalOr(&mut self,)
	-> Result<Rc<ConditionalOrContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			while _la==LOGICAL_OR {
				...
				let temp =  cast_mut::<_,ConditionalOrContext >(&mut _localctx).s9.clone().unwrap()
				 ;
				 cast_mut::<_,ConditionalOrContext >(&mut _localctx).ops.push(temp);
				  
				/*InvokeRule conditionalAnd*/
				recog.base.set_state(47);
				let tmp = recog.conditionalAnd()?;
				 cast_mut::<_,ConditionalOrContext >(&mut _localctx).conditionalAnd = Some(tmp.clone());
				  

				let temp =  cast_mut::<_,ConditionalOrContext >(&mut _localctx).conditionalAnd.clone().unwrap()
				 ;
				 cast_mut::<_,ConditionalOrContext >(&mut _localctx).e1.push(temp);
...
pub type ConditionalAndContext<'input> = BaseParserRuleContext<'input,ConditionalAndContextExt<'input>>;
...
impl<'input> ConditionalAndContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConditionalAndContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ConditionalAndContextExt{
				s8: None, 
				ops: Vec::new(), 
				e: None, relation: None, 
				e1: Vec::new(), 
				ph:PhantomData
			}),
		)
...
pub trait ConditionalAndContextAttrs<'input>: CELParserContext<'input> + BorrowMut<ConditionalAndContextExt<'input>>{
...
fn LOGICAL_AND_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn LOGICAL_AND(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn conditionalAnd(&mut self,)
	-> Result<Rc<ConditionalAndContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			while _la==LOGICAL_AND {
				...
				let tmp = recog.base.match_token(LOGICAL_AND,&mut recog.err_handler)?;
				 cast_mut::<_,ConditionalAndContext >(&mut _localctx).s8 = Some(tmp.clone());
				  

				let temp =  cast_mut::<_,ConditionalAndContext >(&mut _localctx).s8.clone().unwrap()
				 ;
				 cast_mut::<_,ConditionalAndContext >(&mut _localctx).ops.push(temp);
				...
				let temp =  cast_mut::<_,ConditionalAndContext >(&mut _localctx).relation.clone().unwrap()
				 ;
				 cast_mut::<_,ConditionalAndContext >(&mut _localctx).e1.push(temp);
...
pub trait RelationContextAttrs<'input>: CELParserContext<'input> + BorrowMut<RelationContextExt<'input>>{

fn calc(&self) -> Option<Rc<CalcContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn relation_all(&self) ->  Vec<Rc<RelationContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn LESS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn LESS_EQUALS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn GREATER_EQUALS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn GREATER(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn EQUALS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn NOT_EQUALS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn IN(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	self.get_token(IN, 0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<RelationContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 8, RULE_relation, _p);
		...
		let result: Result<(), ANTLRError> = try {
			...
			while { _alt!=2 && _alt!=INVALID_ALT } {
				if _alt==1 {
					...
					_la = recog.base.input.la(1);
					if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << EQUALS) | (1usize << NOT_EQUALS) | (1usize << IN) | (1usize << LESS) | (1usize << LESS_EQUALS) | (1usize << GREATER_EQUALS) | (1usize << GREATER))) != 0)) } {
...
impl<'input> CalcContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CalcContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,CalcContextExt{
				op: None, 
				ph:PhantomData
			}),
		)
...
pub trait CalcContextAttrs<'input>: CELParserContext<'input> + BorrowMut<CalcContextExt<'input>>{

fn unary(&self) -> Option<Rc<UnaryContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn calc_all(&self) ->  Vec<Rc<CalcContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn calc(&self, i: usize) -> Option<Rc<CalcContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token STAR
/// Returns `None` if there is no child corresponding to token STAR
fn STAR(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn SLASH(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
fn PERCENT(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	self.get_token(PERCENT, 0)
}
/// Retrieves first TerminalNode corresponding to token PLUS
/// Returns `None` if there is no child corresponding to token PLUS
fn PLUS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	self.get_token(PLUS, 0)
}
/// Retrieves first TerminalNode corresponding to token MINUS
/// Returns `None` if there is no child corresponding to token MINUS
fn MINUS(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<CalcContextAll<'input>>,ANTLRError> {
		self.calc_rec(0)
	}

	fn calc_rec(&mut self, _p: isize)
	-> Result<Rc<CalcContextAll<'input>>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = CalcContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 10, RULE_calc, _p);
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(4,&mut recog.base)? {
						1 =>{
							...
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << STAR) | (1usize << SLASH) | (1usize << PERCENT))) != 0)) } {
								let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input,'a> Visitable<dyn CELVisitor<'input> + 'a> for UnaryContextAll<'input>{
	fn accept(&self, visitor: &mut (dyn CELVisitor<'input> + 'a)) { self.deref().accept(visitor) }
}
impl<'input,'a> Listenable<dyn CELListener<'input> + 'a> for UnaryContextAll<'input>{
    fn enter(&self, listener: &mut (dyn CELListener<'input> + 'a)) { self.deref().enter(listener) }
    fn exit(&self, listener: &mut (dyn CELListener<'input> + 'a)) { self.deref().exit(listener) }
}
...
pub trait UnaryContextAttrs<'input>: CELParserContext<'input> + BorrowMut<UnaryContextExt<'input>>{
...
pub trait LogicalNotContextAttrs<'input>: CELParserContext<'input>{
	fn member(&self) -> Option<Rc<MemberContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
	/// Retrieves all `TerminalNode`s corresponding to token EXCLAM in current rule
	fn EXCLAM_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
		self.children_of_type()
	}
	...
	fn EXCLAM(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> Borrow<UnaryContextExt<'input>> for LogicalNotContext<'input>{
	fn borrow(&self) -> &UnaryContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<UnaryContextExt<'input>> for LogicalNotContext<'input>{
	fn borrow_mut(&mut self) -> &mut UnaryContextExt<'input> { &mut self.base }
}
...
impl<'input> LogicalNotContextExt<'input>{
	fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>>  {
		Rc::new(
			UnaryContextAll::LogicalNotContext(
...
impl<'input> MemberExprContextExt<'input>{
	fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>>  {
		Rc::new(
			UnaryContextAll::MemberExprContext(
				BaseParserRuleContext::copy_from(ctx,MemberExprContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait NegateContextAttrs<'input>: CELParserContext<'input>{
	...
	fn MINUS_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
		self.children_of_type()
	}
	...
	fn MINUS(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> NegateContextExt<'input>{
	fn new(ctx: &dyn UnaryContextAttrs<'input>) -> Rc<UnaryContextAll<'input>>  {
		Rc::new(
			UnaryContextAll::NegateContext(
				BaseParserRuleContext::copy_from(ctx,NegateContextExt{
					s18:None, 
        			ops:Vec::new(), 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
			...
			,
				2 =>{
					...
					loop {
						...
						let tmp = recog.base.match_token(EXCLAM,&mut recog.err_handler)?;
						if let UnaryContextAll::LogicalNotContext(ctx) = cast_mut::<_,UnaryContextAll >(&mut _localctx){
						ctx.s19 = Some(tmp.clone()); } else {unreachable!("cant cast");}  

						let temp = if let UnaryContextAll::LogicalNotContext(ctx) = cast_mut::<_,UnaryContextAll >(&mut _localctx){
						ctx.s19.clone().unwrap() } else {unreachable!("cant cast");} ;
						if let UnaryContextAll::LogicalNotContext(ctx) = cast_mut::<_,UnaryContextAll >(&mut _localctx){
						ctx.ops.push(temp); } else {unreachable!("cant cast");}  
						}
						}
				...
				3 =>{
					...
					loop {
						match _alt {
							...
							if let UnaryContextAll::NegateContext(ctx) = cast_mut::<_,UnaryContextAll >(&mut _localctx){
							ctx.s18 = Some(tmp.clone()); } else {unreachable!("cant cast");}  

							let temp = if let UnaryContextAll::NegateContext(ctx) = cast_mut::<_,UnaryContextAll >(&mut _localctx){
...
impl<'input> MemberContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<MemberContextAll<'input>> {
		Rc::new(
		MemberContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,MemberContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait MemberContextAttrs<'input>: CELParserContext<'input> + BorrowMut<MemberContextExt<'input>>{
...
pub trait MemberCallContextAttrs<'input>: CELParserContext<'input>{
	...
	fn RPAREN(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		self.get_token(RPAREN, 0)
	}
	/// Retrieves first TerminalNode corresponding to token DOT
	/// Returns `None` if there is no child corresponding to token DOT
	fn DOT(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		self.get_token(DOT, 0)
	}
	/// Retrieves first TerminalNode corresponding to token IDENTIFIER
	/// Returns `None` if there is no child corresponding to token IDENTIFIER
	fn IDENTIFIER(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		self.get_token(IDENTIFIER, 0)
	}
	/// Retrieves first TerminalNode corresponding to token LPAREN
	/// Returns `None` if there is no child corresponding to token LPAREN
	fn LPAREN(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> Borrow<MemberContextExt<'input>> for MemberCallContext<'input>{
	fn borrow(&self) -> &MemberContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<MemberContextExt<'input>> for MemberCallContext<'input>{
	fn borrow_mut(&mut self) -> &mut MemberContextExt<'input> { &mut self.base }
}
...
impl<'input> MemberCallContextExt<'input>{
	fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>>  {
		Rc::new(
			MemberContextAll::MemberCallContext(
				BaseParserRuleContext::copy_from(ctx,MemberCallContextExt{
					op:None, id:None, open:None, 
        			args:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait SelectContextAttrs<'input>: CELParserContext<'input>{
	...
	fn escapeIdent(&self) -> Option<Rc<EscapeIdentContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
	/// Retrieves first TerminalNode corresponding to token QUESTIONMARK
	/// Returns `None` if there is no child corresponding to token QUESTIONMARK
...
impl<'input> SelectContextExt<'input>{
	fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>>  {
		Rc::new(
			MemberContextAll::SelectContext(
				BaseParserRuleContext::copy_from(ctx,SelectContextExt{
					op:None, opt:None, 
        			id:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
...
impl<'input> PrimaryExprContextExt<'input>{
	fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>>  {
		Rc::new(
			MemberContextAll::PrimaryExprContext(
				BaseParserRuleContext::copy_from(ctx,PrimaryExprContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait IndexContextAttrs<'input>: CELParserContext<'input>{
	...
	fn RPRACKET(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	...
	fn LBRACKET(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> IndexContextExt<'input>{
	fn new(ctx: &dyn MemberContextAttrs<'input>) -> Rc<MemberContextAll<'input>>  {
		Rc::new(
			MemberContextAll::IndexContext(
				BaseParserRuleContext::copy_from(ctx,IndexContextExt{
					op:None, opt:None, 
        			index:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<MemberContextAll<'input>>,ANTLRError> {
		self.member_rec(0)
	}

	fn member_rec(&mut self, _p: isize)
	-> Result<Rc<MemberContextAll<'input>>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = MemberContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 14, RULE_member, _p);
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(12,&mut recog.base)? {
						1 =>{
							...
							let mut tmp = SelectContextExt::new(&**MemberContextExt::new(_parentctx.clone(), _parentState));
							...
							if let MemberContextAll::SelectContext(ctx) = cast_mut::<_,MemberContextAll >(&mut _localctx){
							...
							if _la==QUESTIONMARK {
								...
								let tmp = recog.base.match_token(QUESTIONMARK,&mut recog.err_handler)?;
								if let MemberContextAll::SelectContext(ctx) = cast_mut::<_,MemberContextAll >(&mut _localctx){
								ctx.opt = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						2 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = MemberCallContextExt::new(&**MemberContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_member);
							_localctx = tmp;
							...
							let tmp = recog.base.match_token(DOT,&mut recog.err_handler)?;
							if let MemberContextAll::MemberCallContext(ctx) = cast_mut::<_,MemberContextAll >(&mut _localctx){
							ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
							...
							if let MemberContextAll::MemberCallContext(ctx) = cast_mut::<_,MemberContextAll >(&mut _localctx){
							ctx.open = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						3 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = IndexContextExt::new(&**MemberContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_member);
							_localctx = tmp;
							...
							if let MemberContextAll::IndexContext(ctx) = cast_mut::<_,MemberContextAll >(&mut _localctx){
							ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
...
pub trait PrimaryContextAttrs<'input>: CELParserContext<'input> + BorrowMut<PrimaryContextExt<'input>>{
...
pub trait CreateListContextAttrs<'input>: CELParserContext<'input>{
	...
	fn COMMA(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		self.get_token(COMMA, 0)
	}
	fn listInit(&self) -> Option<Rc<ListInitContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> Borrow<PrimaryContextExt<'input>> for CreateListContext<'input>{
	fn borrow(&self) -> &PrimaryContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<PrimaryContextExt<'input>> for CreateListContext<'input>{
	fn borrow_mut(&mut self) -> &mut PrimaryContextExt<'input> { &mut self.base }
}
...
impl<'input> CreateListContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::CreateListContext(
				BaseParserRuleContext::copy_from(ctx,CreateListContextExt{
					op:None, 
        			elems:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
...
impl<'input> IdentContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::IdentContext(
				BaseParserRuleContext::copy_from(ctx,IdentContextExt{
					leadingDot:None, id:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub type CreateStructContext<'input> = BaseParserRuleContext<'input,CreateStructContextExt<'input>>;
...
pub trait CreateStructContextAttrs<'input>: CELParserContext<'input>{
	...
	fn RBRACE(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	...
	fn LBRACE(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	...
	fn mapInitializerList(&self) -> Option<Rc<MapInitializerListContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> CreateStructContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::CreateStructContext(
				BaseParserRuleContext::copy_from(ctx,CreateStructContextExt{
					op:None, 
        			entries:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
...
pub type ConstantLiteralContext<'input> = BaseParserRuleContext<'input,ConstantLiteralContextExt<'input>>;
...
impl<'input> ConstantLiteralContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::ConstantLiteralContext(
				BaseParserRuleContext::copy_from(ctx,ConstantLiteralContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> NestedContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::NestedContext(
				BaseParserRuleContext::copy_from(ctx,NestedContextExt{
        			e:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub type CreateMessageContext<'input> = BaseParserRuleContext<'input,CreateMessageContextExt<'input>>;
...
pub trait CreateMessageContextAttrs<'input>: CELParserContext<'input>{
	...
	fn IDENTIFIER_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
		self.children_of_type()
	}
	...
	fn IDENTIFIER(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
	...
	fn DOT_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
		self.children_of_type()
	}
	/// Retrieves 'i's TerminalNode corresponding to token DOT, starting from 0.
	/// Returns `None` if number of children corresponding to token DOT is less or equal than `i`.
	fn DOT(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		self.get_token(DOT, i)
	}
	fn fieldInitializerList(&self) -> Option<Rc<FieldInitializerListContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> CreateMessageContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::CreateMessageContext(
				BaseParserRuleContext::copy_from(ctx,CreateMessageContextExt{
					leadingDot:None, IDENTIFIER:None, s16:None, op:None, 
        			ids:Vec::new(), ops:Vec::new(), 
        			entries:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
impl<'input> GlobalCallContextExt<'input>{
	fn new(ctx: &dyn PrimaryContextAttrs<'input>) -> Rc<PrimaryContextAll<'input>>  {
		Rc::new(
			PrimaryContextAll::GlobalCallContext(
				BaseParserRuleContext::copy_from(ctx,GlobalCallContextExt{
					leadingDot:None, id:None, op:None, 
        			args:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(25,&mut recog.base)? {
				1 =>{
					...
					if _la==DOT {
						...
						let tmp = recog.base.match_token(DOT,&mut recog.err_handler)?;
						if let PrimaryContextAll::IdentContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.leadingDot = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				2 =>{
					...
					if _la==DOT {
						...
						let tmp = recog.base.match_token(DOT,&mut recog.err_handler)?;
						if let PrimaryContextAll::GlobalCallContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.leadingDot = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				3 =>{
					...
					let tmp = recog.expr()?;
					if let PrimaryContextAll::NestedContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
					ctx.e = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				4 =>{
					...
					let tmp = recog.base.match_token(LBRACKET,&mut recog.err_handler)?;
					if let PrimaryContextAll::CreateListContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
					ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LBRACKET) | (1usize << LBRACE) | (1usize << LPAREN) | (1usize << DOT) | (1usize << MINUS) | (1usize << EXCLAM) | (1usize << QUESTIONMARK) | (1usize << CEL_TRUE) | (1usize << CEL_FALSE) | (1usize << NUL) | (1usize << NUM_FLOAT) | (1usize << NUM_INT) | (1usize << NUM_UINT) | (1usize << STRING) | (1usize << BYTES) | (1usize << IDENTIFIER))) != 0) {
						...
						if let PrimaryContextAll::CreateListContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.elems = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				5 =>{
					...
					if let PrimaryContextAll::CreateStructContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
					ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << LBRACKET) | (1usize << LBRACE) | (1usize << LPAREN) | (1usize << DOT) | (1usize << MINUS) | (1usize << EXCLAM) | (1usize << QUESTIONMARK) | (1usize << CEL_TRUE) | (1usize << CEL_FALSE) | (1usize << NUL) | (1usize << NUM_FLOAT) | (1usize << NUM_INT) | (1usize << NUM_UINT) | (1usize << STRING) | (1usize << BYTES) | (1usize << IDENTIFIER))) != 0) {
						...
						if let PrimaryContextAll::CreateStructContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.entries = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				6 =>{
					...
					if _la==DOT {
						...
						let tmp = recog.base.match_token(DOT,&mut recog.err_handler)?;
						if let PrimaryContextAll::CreateMessageContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.leadingDot = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					let temp = if let PrimaryContextAll::CreateMessageContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
					ctx.IDENTIFIER.clone().unwrap() } else {unreachable!("cant cast");} ;
					if let PrimaryContextAll::CreateMessageContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
					ctx.ids.push(temp); } else {unreachable!("cant cast");}  
					...
					while _la==DOT {
						...
						let tmp = recog.base.match_token(DOT,&mut recog.err_handler)?;
						if let PrimaryContextAll::CreateMessageContext(ctx) = cast_mut::<_,PrimaryContextAll >(&mut _localctx){
						ctx.s16 = Some(tmp.clone()); } else {unreachable!("cant cast");}  
...
pub trait ExprListContextAttrs<'input>: CELParserContext<'input> + BorrowMut<ExprListContextExt<'input>>{
...
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token COMMA, starting from 0.
/// Returns `None` if number of children corresponding to token COMMA is less or equal than `i`.
fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> ListInitContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ListInitContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ListInitContextExt{
				optExpr: None, 
				elems: Vec::new(), 
				ph:PhantomData
			}),
...
pub trait ListInitContextAttrs<'input>: CELParserContext<'input> + BorrowMut<ListInitContextExt<'input>>{

fn optExpr_all(&self) ->  Vec<Rc<OptExprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn optExpr(&self, i: usize) -> Option<Rc<OptExprContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn listInit(&mut self,)
	-> Result<Rc<ListInitContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			let temp =  cast_mut::<_,ListInitContext >(&mut _localctx).optExpr.clone().unwrap()
			 ;
			 cast_mut::<_,ListInitContext >(&mut _localctx).elems.push(temp);
...
pub type FieldInitializerListContext<'input> = BaseParserRuleContext<'input,FieldInitializerListContextExt<'input>>;
...
impl<'input> FieldInitializerListContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldInitializerListContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldInitializerListContextExt{
				s21: None, 
				cols: Vec::new(), 
				optField: None, expr: None, 
				fields: Vec::new(), values: Vec::new(), 
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldInitializerListContextAttrs<'input>: CELParserContext<'input> + BorrowMut<FieldInitializerListContextExt<'input>>{

fn optField_all(&self) ->  Vec<Rc<OptFieldContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn optField(&self, i: usize) -> Option<Rc<OptFieldContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COLON in current rule
fn COLON_all(&self) -> Vec<Rc<TerminalNode<'input,CELParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn COLON(&self, i: usize) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldInitializerList(&mut self,)
	-> Result<Rc<FieldInitializerListContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			let tmp = recog.optField()?;
			 cast_mut::<_,FieldInitializerListContext >(&mut _localctx).optField = Some(tmp.clone());
			  

			let temp =  cast_mut::<_,FieldInitializerListContext >(&mut _localctx).optField.clone().unwrap()
			 ;
			 cast_mut::<_,FieldInitializerListContext >(&mut _localctx).fields.push(temp);
			...
			let temp =  cast_mut::<_,FieldInitializerListContext >(&mut _localctx).s21.clone().unwrap()
			 ;
			 cast_mut::<_,FieldInitializerListContext >(&mut _localctx).cols.push(temp);
			...
			let temp =  cast_mut::<_,FieldInitializerListContext >(&mut _localctx).expr.clone().unwrap()
			 ;
			 cast_mut::<_,FieldInitializerListContext >(&mut _localctx).values.push(temp);
...
impl<'input> OptFieldContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<OptFieldContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,OptFieldContextExt{
				opt: None, 
				ph:PhantomData
			}),
		)
...
pub trait OptFieldContextAttrs<'input>: CELParserContext<'input> + BorrowMut<OptFieldContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn optField(&mut self,)
	-> Result<Rc<OptFieldContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type MapInitializerListContext<'input> = BaseParserRuleContext<'input,MapInitializerListContextExt<'input>>;
...
impl<'input> MapInitializerListContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<MapInitializerListContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,MapInitializerListContextExt{
				s21: None, 
				cols: Vec::new(), 
				optExpr: None, expr: None, 
...
pub trait MapInitializerListContextAttrs<'input>: CELParserContext<'input> + BorrowMut<MapInitializerListContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn mapInitializerList(&mut self,)
	-> Result<Rc<MapInitializerListContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			let temp =  cast_mut::<_,MapInitializerListContext >(&mut _localctx).optExpr.clone().unwrap()
			 ;
			 cast_mut::<_,MapInitializerListContext >(&mut _localctx).keys.push(temp);
			...
			let temp =  cast_mut::<_,MapInitializerListContext >(&mut _localctx).s21.clone().unwrap()
			 ;
			 cast_mut::<_,MapInitializerListContext >(&mut _localctx).cols.push(temp);
			...
			let temp =  cast_mut::<_,MapInitializerListContext >(&mut _localctx).expr.clone().unwrap()
			 ;
			 cast_mut::<_,MapInitializerListContext >(&mut _localctx).values.push(temp);
...
impl<'input> EscapeIdentContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EscapeIdentContextAll<'input>> {
		Rc::new(
		EscapeIdentContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,EscapeIdentContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait EscapeIdentContextAttrs<'input>: CELParserContext<'input> + BorrowMut<EscapeIdentContextExt<'input>>{
...
pub type EscapedIdentifierContext<'input> = BaseParserRuleContext<'input,EscapedIdentifierContextExt<'input>>;
...
pub trait EscapedIdentifierContextAttrs<'input>: CELParserContext<'input>{
	...
	fn ESC_IDENTIFIER(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> Borrow<EscapeIdentContextExt<'input>> for EscapedIdentifierContext<'input>{
	fn borrow(&self) -> &EscapeIdentContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<EscapeIdentContextExt<'input>> for EscapedIdentifierContext<'input>{
	fn borrow_mut(&mut self) -> &mut EscapeIdentContextExt<'input> { &mut self.base }
}
...
impl<'input> EscapedIdentifierContextExt<'input>{
	fn new(ctx: &dyn EscapeIdentContextAttrs<'input>) -> Rc<EscapeIdentContextAll<'input>>  {
		Rc::new(
			EscapeIdentContextAll::EscapedIdentifierContext(
				BaseParserRuleContext::copy_from(ctx,EscapedIdentifierContextExt{
					id:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
impl<'input> SimpleIdentifierContextExt<'input>{
	fn new(ctx: &dyn EscapeIdentContextAttrs<'input>) -> Rc<EscapeIdentContextAll<'input>>  {
		Rc::new(
			EscapeIdentContextAll::SimpleIdentifierContext(
				BaseParserRuleContext::copy_from(ctx,SimpleIdentifierContextExt{
					id:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn escapeIdent(&mut self,)
	-> Result<Rc<EscapeIdentContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
			...
			match recog.base.input.la(1) {
			 IDENTIFIER 
				=> {
					...
					let tmp = recog.base.match_token(IDENTIFIER,&mut recog.err_handler)?;
					if let EscapeIdentContextAll::SimpleIdentifierContext(ctx) = cast_mut::<_,EscapeIdentContextAll >(&mut _localctx){
					ctx.id = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			 ...
			 ESC_IDENTIFIER 
				=> {
					...
					let tmp = recog.base.match_token(ESC_IDENTIFIER,&mut recog.err_handler)?;
					if let EscapeIdentContextAll::EscapedIdentifierContext(ctx) = cast_mut::<_,EscapeIdentContextAll >(&mut _localctx){
					ctx.id = Some(tmp.clone()); } else {unreachable!("cant cast");}  
...
impl<'input> OptExprContextExt<'input>{
	fn new(parent: Option<Rc<dyn CELParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<OptExprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,OptExprContextExt{
				opt: None, 
				e: None, 
				ph:PhantomData
			}),
...
pub trait OptExprContextAttrs<'input>: CELParserContext<'input> + BorrowMut<OptExprContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn optExpr(&mut self,)
	-> Result<Rc<OptExprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait LiteralContextAttrs<'input>: CELParserContext<'input> + BorrowMut<LiteralContextExt<'input>>{
...
pub trait BytesContextAttrs<'input>: CELParserContext<'input>{
	...
	fn BYTES(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> BytesContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::BytesContext(
				BaseParserRuleContext::copy_from(ctx,BytesContextExt{
					tok:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait UintContextAttrs<'input>: CELParserContext<'input>{
	...
	fn NUM_UINT(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> UintContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::UintContext(
				BaseParserRuleContext::copy_from(ctx,UintContextExt{
					tok:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait NullContextAttrs<'input>: CELParserContext<'input>{
	...
	fn NUL(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
pub trait BoolFalseContextAttrs<'input>: CELParserContext<'input>{
	...
	fn CEL_FALSE(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> BoolFalseContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::BoolFalseContext(
...
pub trait StringContextAttrs<'input>: CELParserContext<'input>{
	...
	fn STRING(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> StringContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::StringContext(
...
pub trait DoubleContextAttrs<'input>: CELParserContext<'input>{
	...
	fn NUM_FLOAT(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> DoubleContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::DoubleContext(
				BaseParserRuleContext::copy_from(ctx,DoubleContextExt{
					sign:None, tok:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait BoolTrueContextAttrs<'input>: CELParserContext<'input>{
	...
	fn CEL_TRUE(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
...
impl<'input> BoolTrueContextExt<'input>{
	fn new(ctx: &dyn LiteralContextAttrs<'input>) -> Rc<LiteralContextAll<'input>>  {
		Rc::new(
			LiteralContextAll::BoolTrueContext(
...
pub trait IntContextAttrs<'input>: CELParserContext<'input>{
	...
	fn NUM_INT(&self) -> Option<Rc<TerminalNode<'input,CELParserContextType>>> where Self:Sized{
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(35,&mut recog.base)? {
				1 =>{
					...
					if _la==MINUS {
						...
						let tmp = recog.base.match_token(MINUS,&mut recog.err_handler)?;
						if let LiteralContextAll::IntContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					...
					if let LiteralContextAll::IntContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				2 =>{
					...
					if let LiteralContextAll::UintContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				3 =>{
					...
					if _la==MINUS {
						...
						let tmp = recog.base.match_token(MINUS,&mut recog.err_handler)?;
						if let LiteralContextAll::DoubleContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
						ctx.sign = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				4 =>{
					...
					if let LiteralContextAll::StringContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				5 =>{
					...
					if let LiteralContextAll::BytesContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				6 =>{
					...
					if let LiteralContextAll::BoolTrueContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				7 =>{
					...
					if let LiteralContextAll::BoolFalseContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			...
			,
				8 =>{
					...
					if let LiteralContextAll::NullContext(ctx) = cast_mut::<_,LiteralContextAll >(&mut _localctx){
					ctx.tok = Some(tmp.clone()); } else {unreachable!("cant cast");}  
